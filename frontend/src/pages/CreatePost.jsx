  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        [500px]"
        >
          Create an image beyond imagination and Dall-E API is pretty loyal,
          will never disappoint to surprise you!!
        </p>
        <p
          className="mt-2 text-[#666e75] text-[17px] max-w
        [500px]"
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit} action="">
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type="text"
            name="prompt"
            placeholder="A monkey in shape of an avocado"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            After creating the image you want, you may share it with others in
            the library.
          </p>
          <button
          type="submit"
          className="mt-3 text-white bg-[#6369ff] font-medium rounded-md 
          text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
